...
public class CloneRemoteRepositoryWithAuthentication {
    private static final String REMOTE_URL = "https://github.com/vecent-don/t1.git";
    ...
    public static void main(String[] args) throws IOException, GitAPIException {
        ...
        UsernamePasswordCredentialsProvider provider =new UsernamePasswordCredentialsProvider("vecent-don","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");
